                    ...
                    <div class="d-flex">
                        <h4 class="content-title mb-0 my-auto">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">Liste des Employés</font>
                            </font>
                    ...
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">LISTE DES EMPLOYES</font></font></h4>
                                <i class="mdi mdi-dots-horizontal text-gray"></i>
                            </div>
                            <p class="tx-12 tx-gray-500 mb-2"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Ceci est la liste détailles des employés avec les options modifier et supprimer. </font></font><a href="#"><font style="vertical-align: inherit;"></font></a></p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table text-md-nowrap" id="example1">
                                    ...
                                    <tbody>
                                    <?php if(isset($getPersonnels) AND !empty($getPersonnels)):?>
