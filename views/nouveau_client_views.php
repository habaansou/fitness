                            ...
                            <div class="row">
                                <div class="col-lg-6 col-xl-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" required="" readonly value="<?='FITNESS-'.\_classes\Matricules::getCountMatricule().'::'.date('dmY')?>" type="text" placeholder="Numéro matricule" name="matricule">
                                    </div>
                                    <div class="form-group">
                                        <label class="mg-b-10">Nom</label>
                                        <?php global $nom?>
                                        <input class="form-control" required="" value="<?=$nom?>" type="text" placeholder="Veuillez saisir le nom" name="nom">
                                    </div>
                                    <div class="form-group">
                                        <label class="mg-b-10">Prénom</label>
                                        <?php global $prenom?>
                                        <input class="form-control" required="" value="<?=$prenom?>" type="text" placeholder="Veuillez saisir le prénom" name="prenom">
                                    </div>
                                    <div class="form-group">
                                        <label class="mg-b-10">Date de Naissance</label>
                                        <?php global $datenaissance?>
                                        <input class="form-control" required="" type="date" value="<?=$datenaissance?>" placeholder="Veillez séléctionner la date de naissance" name="datenaissance">
                                    </div>
                                    <div class="form-group">
                                        <label class="mg-b-10">Téléphone</label>
                                        <?php global $telephone?>
                                        <input class="form-control" required="" value="<?=$telephone?>" type="number" placeholder="Veuillez saisir le numéro" name="telephone">
                                    </div>
                                    <div class="row row-xs wd-xl-80p">
                                        <div class="col-sm-6 col-md-3">
                                            <button class="btn btn-indigo btn-with-icon btn-block"><i class="typcn typcn-input-checked"></i> Enregistrer</button>
                                        </div>
                                ...
                                <div class="col-lg-6 col-xl-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php global $cin?>
                                        <input class="form-control" required="" value="<?=$cin?>"  type="text" placeholder="Veuillez saisir le numéro de la carte nationnal" name="cin">
                                    </div>
                                    <div class="form-group">
                                        <label class="mg-b-10">Lieu de Naissance</label>
                                        <?php global $lieu?>
                                        <input class="form-control" required="" value="<?=$lieu?>" type="text" placeholder="Veuillez saisir le lieu de naissance" name="lieu">
                                    </div>
                                    <div class="form-group">
                                        <label class="mg-b-10">Email</label>
                                        <?php global $email?>
                                        <input class="form-control" required="" value="<?=$email?>" type="text" placeholder="Veuillez sairir l'adresse email" name="email">
                                    </div>
                                    <div class="form-group">
